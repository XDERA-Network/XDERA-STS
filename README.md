...
- **Preview / Demo**: https://xdera.web.id/docs/demo/sts/client
- **Full Potential Demo**: https://ai.xdera.web.id

## Usage

Fill the config, refresh, and stop complaining. For the API key, join the discord server below.

```javascript
const XD_CONFIG = {
    aCore: "xdera-sts-2.8-stable",
    aPrompt: "Be a good girl",
    aTemprature: 0.8
};
```
...
Join here to get your API key: https://discord.com/invite/YXhxpBcT9H

## Features

- Voice and text.
- Security layer so people don't steal your keys.
- Unlimited and free usage (subject to your behavior).
